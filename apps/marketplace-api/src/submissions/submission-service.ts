...
export class SubmissionError extends Error {
  constructor(readonly code: 'PACKAGE_TOO_LARGE' | 'VALIDATION_FAILED' | 'SUBMISSION_NOT_FOUND' | 'SKILL_NOT_FOUND' | 'ADMIN_ACCESS_DENIED' | 'SUBMISSION_STATE_CONFLICT' | 'LIFECYCLE_STATE_CONFLICT' | 'UPLOAD_FAILED' | 'PACKAGE_HASH_MISMATCH' | 'REVIEW_REASON_REQUIRED' | 'PUBLISH_FAILED', message: string, readonly status: number) { super(message) }
}
